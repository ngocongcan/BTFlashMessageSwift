...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let _ = BTFlashMessage.showAdd(toView: self.view, type: .warning, message: "This alert box indicates a warning that might need attention.", margin: UIEdgeInsetsMake(180, 0, 0, 0), animated: true, dismissAfter: nil)
        

        let _ = BTFlashMessage.showAdd(toView: self.view, type: .danger, message: "This alert box indicates a dangerous or potentially negative action. ", margin: UIEdgeInsetsMake(280, 0, 0, 0), animated: true, dismissAfter: nil)
